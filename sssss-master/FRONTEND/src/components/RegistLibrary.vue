...
<!-- 
        ...
        <v-list-item>
          <v-list-item>
            <v-icon color="light-green darken-2">mdi-storefront</v-icon>
            <v-list-item-title>매점</v-list-item-title>
            <v-list-item-title>
              <v-radio-group 
                v-model="Place.library.convenience" row fluid >  
                <v-radio name='convenience' color="grey darken-1" label="있음" value="O" required></v-radio>
                <v-radio name='convenience' color="grey darken-1" label="없음" value="X" required></v-radio>
              </v-radio-group>  
            </v-list-item-title>
          </v-list-item>
        </v-list-item>
        ...
        <v-list-item>
          <v-list-item>
            <v-icon color="light-green darken-2">mdi-laptop-windows</v-icon>
            <v-list-item-title>노트북 열람실</v-list-item-title>
            <v-list-item-title>
              <v-radio-group v-model="Place.library.notebook" row fluid>
                <v-radio name="notebook" color="grey darken-1" label="있음" value="O" required></v-radio>
                <v-radio name="notebook" color="grey darken-1" label="없음" value="X" required></v-radio>
              </v-radio-group> 
            </v-list-item-title>
          </v-list-item>
        </v-list-item>
...
export default {
    ...
    methods:{        
        preprocess(){
            if( this.Place.library.convenience =="X")
                this.Place.library.convenience="False";
            else
                this.Place.library.convenience="True";
            if( this.Place.library.notebook =="X")
                this.Place.library.notebook="False";
            else
                this.Place.library.notebook="True";
        ...
        registdetail(){
            ...
            axios_common            
            .post('/registdetail/3/',this.Place                        
            ).then(response=>{
